...
{
	2, 1, 1, 1, 2, 1, 2, 2, 2, 2, 2, 1, 1, 1, 2, 2, 2, 2, 1, 1, 2, 2, 1, 1, 2, 1, 2, 2, 2, 1, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1, 2
};
...
void SSD1306::draw_string(unsigned int x_pos, unsigned int y_pos, char *string)
{
	...
	while(*string)
	{
		...
		else if(isupper(*string))
		{
			...
			// some letters need specific space.
			if(*string == 'M')
			{
				x_pos_new += 5;
			}
